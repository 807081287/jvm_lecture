...
说明：
    ...
    ExtClassLoader的父加载器为：BootStrap，该类加载器在本JDK中用null表示。

类加载器的双亲委托模型的好处：
	1. 可以确保Java核心库的类型安全：所有的Java应用都至少会引用java.lang.Object类，
	也就是说在运行期，java.lang.Object这个类会被加载到虚拟机中，
